...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Agrega un nuevo servicio a tu catálogo de StyleCut</p>
        </div>

        <div class="service-form-card">
            <form class="form-content" id="service-form" action="../controladores/agregar_servicio.php" method="POST">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-input" placeholder="Ej: Corte de Cabello Premium" required>
                            <div class="form-help">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="descripcion" name="descripcion" class="form-textarea" placeholder="Describe detalladamente el servicio, beneficios y características..." required></textarea>
                            <div class="form-help">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="precio" name="precio" class="form-input" placeholder="0" min="0" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="duracion" name="duracion" class="form-input" placeholder="0" min="0" required>
